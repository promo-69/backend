...
export default class RentalRequestsModel extends SequelizeModelBase {
    static definition() {
        return {
            ...
            // Rastro de pago (se completa al cobrar desde taquilla / POS)
            payment_method: { allowNull: true, type: DataTypes.INTEGER },
            payment_reference: { allowNull: true, type: DataTypes.STRING(255) },
            paid_by_employee: { allowNull: true, type: DataTypes.INTEGER },
