        ...
        return [
            {
                ...
                options: { foreignKey: 'modifier_scope', targetKey: 'id', as: '_ModifierScope' },
            },
            {
                inversed: true,
                type: 'hasMany',
            ...
            },
            {
                ...
                options: { foreignKey: 'audience_category', targetKey: 'id', as: '_AudienceCategory' },
            },
            {
                inversed: true,
                type: 'hasMany',
            ...
            },
            {
                type: 'belongsTo',
                target: 'WeekDays',
                options: { foreignKey: 'week_day', targetKey: 'id', as: '_WeekDay' },
            },
            {
                inversed: true,
                type: 'hasMany',
            ...
            },
            {
                ...
                type: 'hasMany',
                target: 'Statuses',
                options: { foreignKey: 'status', targetKey: 'id', as: '_PriceModifiers' },
            },
        ];
    }
}
