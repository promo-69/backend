...
import { CacheDatabaseProvider } from '@shared/providers/cache-database.provider.js';
...
export class RealtimeProvider {
  ...
  static getInstance(): RealtimeProvider {
    ...
    if (!globalWithRealtime[REALTIME_PROVIDER_SYMBOL]) globalWithRealtime[REALTIME_PROVIDER_SYMBOL] = new RealtimeProvider();
