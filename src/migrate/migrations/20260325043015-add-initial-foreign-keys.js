...
module.exports = {
    async up(queryInterface, Sequelize) {
        ...
        const foreignKeys = [
            ...
            { table: 'job_positions', field: 'status', target: 'statuses', name: 'fk_job_positions_status' },
            ...
            { table: 'employee_positions', field: 'status', target: 'statuses', name: 'fk_employee_positions_status' },

            { table: 'loyalty_levels', field: 'status', target: 'statuses', name: 'fk_loyalty_levels_status' },
            ...
            { table: 'orders', field: 'customer', target: 'customers', name: 'fk_orders_customer' },
            {
                ...
                name: 'fk_orders_employee_position',
            },
