...
CREATE UNIQUE INDEX idx_employees_people_uq ON employees (person);
...
CREATE UNIQUE INDEX idx_customers_people_uq ON customers (person);
...
CREATE UNIQUE INDEX idx_modifier_scopes_description_uq ON modifier_scopes (description);
...
ALTER TABLE users ADD CONSTRAINT fk_users_people FOREIGN KEY (person) REFERENCES people(id);
...
ALTER TABLE employees ADD CONSTRAINT fk_employees_people FOREIGN KEY (person) REFERENCES people(id);
...
ALTER TABLE customers ADD CONSTRAINT fk_customers_people FOREIGN KEY (person) REFERENCES people(id);
